            ...
            <div id="personal-data-container" class="personal-data-container text-left">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control required" name="birthday" id="customer-birthday" fieldType="date"  required-message="Ingresa tu fecha de nacimiento" error-message="Ingrese una fecha válida">
                    </div>
                </div>
